...
| ss. 8–11 | Live ratios; reduced-ratio windows & floors; never count volunteers/students/RCs; 6+ children ⇒ 2 staff | `staff_shift`, `attendance_event`; `domain/ratios` | Room home, supervisor home | `s8_*`, `s11_*` | 0 (engine) / 1 (live) | 🔶 engine ✅, live board P1 |
